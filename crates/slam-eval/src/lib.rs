//! Ground-truth trajectory I/O and timestamp-interpolated pose lookup, used
//! to evaluate estimated trajectories against
//! `state_groundtruth_estimate0/data.csv` (Stage 1 milestone M0; ATE/RPE
//! come later, in M9).
